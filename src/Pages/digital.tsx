...
export default function Digital() {
    ...
    return (
        <div className=" mx-auto flex items-center justify-center p-28">
            <div className="w-[1216px] flex  gap-16 justify-center bg-primary p-16 rounded ">
                <div className="flex flex-col items-start justify-center ">
                    ...
                    <div className="text-base font-semibold font-inter leading-lnL pt-4">
